      ...
      <div className="container-custom">
        ...
        <div className="bg-card rounded-2xl p-8 md:p-12 shadow-sm border border-border/50">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="font-heading font-bold text-2xl md:text-3xl mb-6 text-foreground">
                Nossa Missão
              </h3>
            ...
            <div className="relative">
              <div className="aspect-square bg-hero-gradient rounded-2xl flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center text-white z-10">
                  <div className="text-5xl md:text-6xl font-bold mb-2">18+</div>
                  <div className="text-lg md:text-xl font-medium">Anos de</div>
                  <div className="text-lg md:text-xl font-medium">Experiência</div>
                </div>
                {/* Decorative elements */}
